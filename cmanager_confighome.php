...
class block_cmanager_confighome_form extends moodleform {
    ...
    public function definition() {
        ...
        <td><b><a href=\"cmanager_adminsettings.php\">" . get_string('configureadminsettings', 'block_cmanager')  . "</a></b><br>"
            . get_string('configureadminsettings_desc', 'block_cmanager') . "</td>
        </tr>

        <tr>
        <td style=\"padding:25px; width:30px\"><img src=\"icons/config/email.png\"></td>

        <td><b><a href=\"cmanager_config.php\">". get_string('configureemailsettings', 'block_cmanager')."</a></b><br>"
            . get_string('configureemailsettings_desc', 'block_cmanager') . "</td>
        ...
        <td><b><a href=\"formeditor/page1.php\">". get_string('configurecourseformfields', 'block_cmanager') . "</a></b><br>"
            . get_string('configure_instruction2', 'block_cmanager') . "</td>
        </tr>

        <tr>
        <td style=\"padding:25px; width:30px\"><img src=\"icons/config/config2.png\"></td>
        <td><b><a href=\"formeditor/form_builder.php\">" . get_string('informationform', 'block_cmanager') . "</a></b><br>"
            . get_string('configure_instruction3', 'block_cmanager')  . "
        </td>
