...
/**
 * Add a new menu item into the optional drop down field on form page 1.
 *
 * @return void
 */
function addNewItem(){
...
function saveAllChanges(langString){
    ...
    jQuery.ajaxSetup({async:false});
        $.post("ajax_functions.php", { f1t: field1title, f1d: field1desc, f2t: field2title, f2d: field2desc,
                f3d: field3desc, type: 'save', dstat: dropdownStatus},
...
class block_cmanager_page1_form extends moodleform {
    ...
    public function definition() {
        ...
        foreach ($field3items as $item) {
            ...
            $field3itemshtml .= '<div class="col-sm-2"><a href="page1.php?del=' . $item->id . '" aria-label="'
        ...
        $fieldshtml = '
            <p><a href="../cmanager_confighome.php" class="btn btn-default"><img src="../icons/back.png" alt=""> '
            ...
            <div class="row">
                <div class="col-sm-1"><label for="field1title">' . get_string('entryFields_Name', 'block_cmanager')
                        . '</label></div>
                <div class="col-sm-3"><input type="text" id = "field1title" size="50" value = "' . $field1title . '"/></div>
            </div>
            <div class="row">
                <div class="col-sm-1"><label for="field1desc">' . get_string('entryFields_Description', 'block_cmanager')
                    . '</label></div>
            ...
            <div class="row">
                <div class="col-sm-1"><label for="field2title">' . get_string('entryFields_Name', 'block_cmanager')
                        . '</label></div>
                <div class="col-sm-3"><input type="text" id = "field2title" size="50" value = "' . $field2title . '"/></div>
            </div>
            <div class="row">
                <div class="col-sm-1"><label for="field2desc">' . get_string('entryFields_Description', 'block_cmanager')
                        . '</label></div>
            ...
            <div class="row">
                <div class="col-sm-1"><label for="dropdownstatus">' . get_string('entryFields_status', 'block_cmanager')
                        . '</label></div>
                <div class="col-sm-3">' . $field3html . '</div>
            </div>
            <div class="row">
                <div class="col-sm-1">' . get_string('entryFields_values', 'block_cmanager') . '</div>
                <div class="col-sm-3">' . format_text($field3itemshtml, FORMAT_HTML, ['context' => context_system::instance()])
                        . '</div>
            </div>
            <div class="row">
                <div class="col-sm-3 offset-md-1">
                    <input type="text" id="newitem"><input class="btn-default" type="submit" name="submitbutton" value="'
                            . get_string('entryFields_AddNewItem', 'block_cmanager') . '" onclick="addNewItem();"></div>
            </div>
            <button class="btn-primary" type="button" onclick="saveAllChanges(\''
                    . get_string('ChangesSaved', 'block_cmanager').'\');">' . get_string('SaveChanges', 'block_cmanager').'
            </button>
        ';

        $fieldshtml .= generategenericpop('saved', get_string('ChangesSaved', 'block_cmanager'),
                get_string('ChangesSaved', 'block_cmanager'), get_string('ok', 'block_cmanager') );
