...
$backLink = '';
switch ($type) {
    case 'adminarch': $backLink = 'cmanager_admin_arch.php'; break;
    case 'adminq': $backLink = 'cmanager_admin.php'; break;
    case 'userq': $backLink = 'module_manager.php'; break;
}
...
class block_cmanager_comment_form extends moodleform {
    ...
    function definition() {
        ...
        $htmlOutput = '<h2 class="h4 mt-3 p-2" style="border: 1px #000000 solid; width:100%; background: #E0E0E0">'.get_string('comments','block_cmanager').'</h2>';
