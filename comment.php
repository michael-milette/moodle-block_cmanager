...
class block_cmanager_comment_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('html', '
                ...
                <input class="btn btn-primary mt-3" type="submit" value="'
                        . get_string('comments_PostComment', 'block_cmanager') . '">
                <a href="' . $backlink . '" class="btn btn-secondary mt-3"> ' . get_string('cancel') . '</a>
        ');
        ...
        $htmloutput = '<h2 class="h4 mt-3 p-2" style="border: 1px #000000 solid; width:100%; background: #E0E0E0">'
                . get_string('comments', 'block_cmanager') . '</h2>';
