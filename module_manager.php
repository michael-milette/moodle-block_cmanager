...
var id = 0;
// Pop up a modal to ask the user are they sure that they want to cancel the request.
...
class block_cmanager_module_manager_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('html', '<p><a class="btn btn-default" href="course_request.php?mode=1">'
                . get_string('cmanagerRequestBtn', 'block_cmanager') . '</a></p>');
        $uid = $USER->id;
        ...
        $outputhtml .= '
        <script>
        // Cancel request click handler. Just does a hard redirect to the delete page and back.
