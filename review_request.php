 ...
 * @copyright  2020-2023 TNG Consulting Inc.
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_cmanager_review_request_form extends moodleform {
    ...
    public function definition() {
        ...
        $buttonarray = array();
        $buttonarray[] = &$mform->createElement('submit', 'submitbutton', get_string('requestReview_SubmitRequest',
                'block_cmanager'));
...
if ($mform->is_cancelled()) {
    ...
    blockcmanagerrequestnewmodemailadmins($replacevalues);

    // Send email to user to track that we are requesting a new mod.
    blockcmanagerrequestnewmodemailuser($USER->id, $replacevalues);
